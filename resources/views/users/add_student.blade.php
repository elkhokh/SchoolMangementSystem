        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 text-end">
                    <a class="btn btn-primary" href="{{ route('users.student') }}">رجوع</a>
                </div>

                <form class="parsley-style-1" autocomplete="off" action="{{ route('users.add_student') }}" method="post" enctype="multipart/form-data">
                    @csrf
