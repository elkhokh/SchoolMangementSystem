        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div class="d-flex align-items-center">
                <h4 class="mb-0 content-title">
                    <i class="la la-user-plus"></i> المدرسين
                </h4>
                <span class="text-muted mx-2">/ إضافة مدرس</span>
            </div>
                    ...
                    <form class="parsley-style-1" autocomplete="off" action="{{ route('teachers.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" name="name" type="text" value="{{ old('name') }}" placeholder="أدخل اسم المدرس...">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" name="specialization" type="text" value="{{ old('specialization') }}" placeholder="أدخل التخصص...">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" name="phone" type="tel" value="{{ old('phone') }}" placeholder="أدخل رقم الهاتف...">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                ...
                                <textarea class="form-control" name="note" rows="4" placeholder="أدخل ملاحظات إضافية...">{{ old('note') }}</textarea>
