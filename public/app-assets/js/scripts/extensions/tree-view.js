...
$(document).ready(function(){
    ...
    var findDisabledNodes = function() {
        return $disabledTree.treeview('admin.search', [$('#input-disable-node').val(), {
            ignoreCase: false,
            exactMatch: false
        }]);
    };
    ...
    $('#btn-disable-all').on('click', function(e) {
        $disabledTree.treeview('admin.disableAll', {
            silent: $('#chk-disable-silent').is(':checked')
        });
    });

    $('#btn-enable-all').on('click', function(e) {
        $disabledTree.treeview('admin.enableAll', {
            silent: $('#chk-disable-silent').is(':checked')
        });
    });
    ...
    var search = function(e) {
        ...
        var results = $searchableTree.treeview('admin.search', [pattern, options]);
    ...
    $('#btn-clear-search').on('click', function(e) {
        $searchableTree.treeview('admin.clearSearch');
        $('#input-search').val('');
        $('#search-output').html('');
    });
    ...
    var findSelectableNodes = function() {
        return $selectableTree.treeview('admin.search', [$('#input-select-node').val(), {
            ignoreCase: false,
            exactMatch: false
        }]);
    };
    ...
    $('#btn-select-node.select-node').on('click', function(e) {
        $selectableTree.treeview('admin.selectNode', [selectableNodes]);
    });

    $('#btn-unselect-node.select-node').on('click', function(e) {
        $selectableTree.treeview('admin.unselectNode', [selectableNodes]);
    });

    $('#btn-toggle-selected.select-node').on('click', function(e) {
        $selectableTree.treeview('admin.toggleNodeSelected', [selectableNodes]);
    });
    ...
    $('#btn-expand-all').on('click', function(e) {
        ...
        $expandibleTree.treeview('admin.expandAll', {
            levels: 2
        });
    });

    $('#btn-collapse-all').on('click', function(e) {
        $expandibleTree.treeview('admin.collapseAll');
    });
    ...
    $('#btn-check-all').on('click', function(e) {
        $checkableTree.treeview('admin.checkAll', {
            silent: $('#chk-check-silent').is(':checked')
        });
    });

    $('#btn-uncheck-all').on('click', function(e) {
        $checkableTree.treeview('admin.uncheckAll', {
            silent: $('#chk-check-silent').is(':checked')
        });
    });
});